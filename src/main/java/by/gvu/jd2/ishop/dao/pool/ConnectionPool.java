package by.gvu.jd2.ishop.dao.pool;
...
public final class ConnectionPool {
    ...
    public void initPoolData() throws ConnectionPoolException {
        try{
            ...
            throw new ConnectionPoolException("Driver not found ConnectionPool", e);
        }
    }
    ...
    private void clearConnectionQueue(){
        try{
            ...
            System.err.println("Error closing connection ConnectionPool");
        }
    }
    ...
    public void closeConnection(Connection con, Statement st, ResultSet rs){
        try{
            ...
            System.err.println("Connection isn't return to the pool");
        }

        try{
            rs.close();
        }catch (SQLException e){
            System.err.println("ResultSet isn't closed");
        }
